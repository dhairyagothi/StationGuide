...
const ComplainBox = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-blue-5000">
      ...
      {alert && (
        <div
          className={`w-full max-w-sm p-4 mb-4 rounded-lg ${
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center"
