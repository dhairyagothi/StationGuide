  ...
  const basicQuestions = [
    {
      ...
      answer:
        "StationSaarthi is a platform designed to enhance your Indian Railway Station experience, providing features like live train updates, navigation, and personalized recommendations.",
    },
    {
      question: "How does StationSaarthi work?",
      answer:
        "Simply download the StationSaarthi app or visit our website to access our services. You can use our platform to get real-time train information, navigate within stations, find amenities, and more.",
    },
    {
      question: "Is StationSaarthi free to use?",
      answer:
        "Yes, StationSaarthi is a free platform. You can use all of our features without any subscription fees.",
    },
    {
      question: "How can I check the arrival and departure times of my train?",
      answer:
        "You can easily check your train's arrival and departure times by entering its number or name on our platform.",
    },
    {
      question: "Can I track the real-time location of my train?",
      answer:
        "Yes, StationSaarthi provides real-time train tracking. You can see the exact location of your train on a map.",
    },
  ];
